  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 16px" }}>
      ...
      <section style={{ padding: "48px 0 32px", textAlign: "center" }}>
        <h1 style={{ fontSize: 32, fontWeight: "bold", marginBottom: 12, lineHeight: 1.4 }}>
      ...
      {/* 注意書き */}
      <div style={{ background: "#1a1a1a", border: "1px solid #2a2a2a", borderRadius: 6, padding: "12px 16px", marginBottom: 32, fontSize: 13, color: "#888" }}>
        ⚠️ 本サイトは18歳以上の方を対象としています。18歳未満の方はご利用をお控えください。
      </div>

      {/* 人気ランキング TOP3 */}
      <section style={{ marginBottom: 48 }}>
        <h2 style={{ fontSize: 22, fontWeight: "bold", marginBottom: 24, paddingBottom: 8, borderBottom: "2px solid #e50914" }}>
          🏆 今週の人気ランキング TOP3
        </h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: 16 }}>
          {[
            ...
            <div key={i} style={{ background: "#1a1a1a", border: "1px solid #2a2a2a", borderRadius: 8, padding: 20 }}>
              ...
              <h3 style={{ fontWeight: "bold", marginBottom: 6 }}>{item.title}</h3>
